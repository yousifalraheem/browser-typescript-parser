...
describe("TypescriptParser", () => {
    ...
    describe("Source parsing", () => {
        it("should parse a source code string correctly", async () => {
            const parsed = await parser.parseSource(
                `import {foo} from 'bar'; class Foobar {}; const bar = new Foobar();`,
            );
    ...
    describe("TSX: Specific cases", () => {
        const testFiles = [
            {
                filename: "1.tsx",
                requiredUsages: ["sortBy", "Divider", "Checkbox"],
            },
            {
                filename: "2.tsx",
                requiredUsages: ["ActionDelete", "Divider", "cloneDeep"],
            },
            {
                filename: "3.tsx",
                requiredUsages: ["ImageEdit", "IconButton", "TableHeaderColumn"],
            },
        ];
