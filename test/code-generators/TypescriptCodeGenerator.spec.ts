...
import {
    ...
    MultiLineImportRule,
} from "../../src/code-generators/TypescriptGenerationOptions";
...
namedImport.specifiers = [new SymbolSpecifier("spec1"), new SymbolSpecifier("spec2", "alias2")];
...
describe("TypescriptCodeGenerator", () => {
    ...
    const generatables = [
        ...
        new MethodDeclaration("myMethod", false, DeclarationVisibility.Public, "void", false, false, false),
        new MethodDeclaration("myAbstractMethod", true, DeclarationVisibility.Public, "string", false, false, false),
        new MethodDeclaration("myProtectedMethod", false, DeclarationVisibility.Protected, "void", false, false, false),
        ...
        new MethodDeclaration("myPrivateMethod", false, DeclarationVisibility.Private, "void", false, false, false),
        new MethodDeclaration(
            "myPrivateAbstractMethod",
            true,
        ...
        new PropertyDeclaration("pubProperty", DeclarationVisibility.Public, "string", false, false),
        new PropertyDeclaration("protProperty", DeclarationVisibility.Protected, "number", false, false),
        new PropertyDeclaration("prvProperty", DeclarationVisibility.Private, "boolean", false, false),
        new VariableDeclaration("myVar", false, false, "string"),
        new VariableDeclaration("myConst", true, false, "string"),
        new GetterDeclaration("pubGetter", DeclarationVisibility.Public, "string", false, false),
        new GetterDeclaration("protGetter", DeclarationVisibility.Protected, "string", false, false),
        new GetterDeclaration("privGetter", DeclarationVisibility.Private, "string", false, false),
        new GetterDeclaration("pubNoTypeGetter", DeclarationVisibility.Public, undefined, false, false),
        new GetterDeclaration("protNoTypeGetter", DeclarationVisibility.Protected, undefined, false, false),
        new GetterDeclaration("privNoTypeGetter", DeclarationVisibility.Private, undefined, false, false),
        new GetterDeclaration("pubAbsGetter", DeclarationVisibility.Public, "number", true, false),
        new GetterDeclaration("protAbsGetter", DeclarationVisibility.Protected, "number", true, false),
        new GetterDeclaration("privAbsGetter", DeclarationVisibility.Private, "number", true, false),
        new SetterDeclaration("pubSetter", DeclarationVisibility.Public, "string", false, false),
        new SetterDeclaration("protSetter", DeclarationVisibility.Protected, "string", false, false),
        new SetterDeclaration("privSetter", DeclarationVisibility.Private, "string", false, false),
        new SetterDeclaration("pubNoTypeSetter", DeclarationVisibility.Public, undefined, false, false),
        new SetterDeclaration("protNoTypeSetter", DeclarationVisibility.Protected, undefined, false, false),
        new SetterDeclaration("privNoTypeSetter", DeclarationVisibility.Private, undefined, false, false),
        new SetterDeclaration("pubAbsSetter", DeclarationVisibility.Public, "number", true, false),
        new SetterDeclaration("protAbsSetter", DeclarationVisibility.Protected, "number", true, false),
        new SetterDeclaration("privAbsSetter", DeclarationVisibility.Private, "number", true, false),
    ];
    ...
    it("should throw on non generatable element", () => {
        ...
        expect(() => generator.generate(new ClassDeclaration("foo", true))).toThrow(Error);
    });
});
